...
LIBS_DIR = ROOT_DIR / 'fuzzercorn' / 'lib'
HEADERS_DIR = ROOT_DIR / 'fuzzercorn' / 'include'
SRC_DIR = ROOT_DIR / '..' / '..'
...
if SYSTEM == 'darwin':
    LIBRARY_FILE = "libfuzzercorn.dylib"
    STATIC_LIBRARY_FILE = None
else:
    LIBRARY_FILE = "libfuzzercorn.so"
    STATIC_LIBRARY_FILE = None
